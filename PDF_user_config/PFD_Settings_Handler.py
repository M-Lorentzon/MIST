import PDF_user_config.popup_settings as popup
import PDF_user_config.PDF_Data as container
import json
...
class PDF_Settings_Handler:
    ...
    def Parse_json_settings(self):
        with open("PDF_user_config/json_xrd_pdf.txt", 'r') as infile:
    ...
    def Save_data_to_json_file(self):
        ...
        with open("PDF_user_config/json_xrd_pdf.txt", "w") as outfile:
