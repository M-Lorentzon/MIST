...
class Application:
    def __init__(self, window):
        ...
        self.list_of_objects = [(self.o_MOS_script, self.b_select_mos), (self.o_XRD1_script, self.b_select_xrd1),
                                ...
                                (self.o_xps_data, self.b_select_xps), (self.o_PIXE, self.b_select_pixe),
                                (self.o_asterix_PF, self.b_select_Asterix_PF), (self.o_SRIM, self.b_select_srim),
                                (self.o_2D_Image, self.b_select_2d_image), (self.o_quick_script, self.b_select_quick_script),
                                (self.o_Plot_2D_Integrated_WAX, self.b_select_2D_WAX), (self.o_Plasma_probe, self.b_select_Plasma)]
